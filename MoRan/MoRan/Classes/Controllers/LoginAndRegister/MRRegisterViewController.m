...
@interface MRRegisterViewController () <MRRegisterRequestDelegate>

@property (nonatomic, strong) MRRegisterRequest *registerRequest;
...
- (void)registerHandle
{
    ...
    self.registerRequest = [[MRRegisterRequest alloc] init];
...
#pragma mark - MRRegisterRequestDelegate methods
