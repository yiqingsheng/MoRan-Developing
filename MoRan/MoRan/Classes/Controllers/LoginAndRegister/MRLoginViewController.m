...
@interface MRLoginViewController () <MRLoginRequestDelegate>

@property (nonatomic, strong) MRLoginRequest *loginRequest;
...
- (void)loginHandle
{
    ...
    self.loginRequest = [[MRLoginRequest alloc] init];
...
#pragma mark - MRLoginRequestDelegate methods
